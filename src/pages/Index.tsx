...
const Index = () => {
      ...
      <div className="space-y-2">
        {Array.from({ length: maxLevel }, (_, i) => i + 1).map((level) => (
          <div key={level} className="flex justify-between items-center">
            <span className="text-sm dark:text-gray-300">Level {level}</span>
            <div className="flex">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button 
              ...
              className="bg-white dark:bg-gray-800 hover:bg-purple-50 dark:hover:bg-purple-900 border-2 border-purple-200 dark:border-purple-700 hover:border-purple-400 text-purple-700 dark:text-purple-300"
            >
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">智能評測系統特色</h3>
      ...
      <section className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">香港教育局標準對接</h3>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
